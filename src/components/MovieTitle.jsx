...
const MovieTitle = ({title,overview}) => {
  return (
    <div className='w-screen aspect-video absolute pt-[20%] px-24 text-white bg-gradient-to-r from-black '>
      ...
      <div className='flex'>
        <button className='bg-white text-black p-4 px-8 text-xl rounded-lg hover:bg-opacity-80 flex items-center'><img src='public/play.png' className='w-24 pr-'/>Play</button>
